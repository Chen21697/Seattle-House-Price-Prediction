...
# -*- coding: utf-8 -*-
"""
Created on Wed Oct  7 02:43:02 2020
...
# Trial 4
train_numFea = trainingSet[['bedrooms', 'bathrooms', 'yr_built', 'sqft_living', 'sqft_lot', 'floors', 'view', 'condition', 'grade', 'sqft_above', 'lat', 'long', 'sqft_basement', 'sqft_living15', 'sqft_lot15', 'month']]
train_catFea = trainingSet[['waterfront', 'yr_renovated', 'zipcode', 'day', 'year']]

vali_numFea = valSet[['bedrooms', 'bathrooms','yr_built', 'sqft_living', 'sqft_lot', 'floors', 'view','condition', 'grade', 'sqft_above', 'lat', 'long', 'sqft_basement', 'sqft_living15', 'sqft_lot15', 'month']]
vali_catFea = valSet[['waterfront', 'yr_renovated', 'zipcode', 'day', 'year']]
...
concat_train_cat = pd.concat([train_catFea, train_yr_renovated, train_zipcode, train_day, train_year], axis=1)
train_catFea = concat_train_cat.drop(columns=['yr_renovated', 'zipcode', 'day', 'year'])
...
concat_vali_cat = pd.concat([vali_catFea, vali_yr_renovated, vali_zipcode, vali_day, vali_year], axis=1)
vali_catFea = concat_vali_cat.drop(columns=['yr_renovated', 'zipcode', 'day', 'year'])
